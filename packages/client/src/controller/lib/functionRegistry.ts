...
const REGISTRY: FunctionDef[] = [
  ...
  },
  {
    ...
    type: 'coord',
    args: [
      { name: 'nSides', default: 4, min: 1, max: 20, step: 1 },
    ],
  },
  {
    name: 'scroll',
  ...
  },
  {
    ...
    type: 'color',
    args: [
      { name: 'amount', default: 1, min: 0, max: 1, step: 0.01 },
    ],
  },
  {
    name: 'contrast',
    type: 'color',
    args: [
      { name: 'amount', default: 1.6, min: 0, max: 4, step: 0.05 },
    ],
  },
  {
    name: 'brightness',
    type: 'color',
    args: [
      { name: 'amount', default: 0.4, min: -1, max: 2, step: 0.05 },
    ],
  },
  {
    name: 'luma',
  ...
  },
  {
    ...
    type: 'color',
    args: [
      { name: 'amount', default: 2, min: 0, max: 10, step: 0.1 },
    ],
  },
  {
    name: 'hue',
    type: 'color',
    args: [
      { name: 'hue', default: 0.4, min: 0, max: 1, step: 0.01 },
    ],
  },
  {
    name: 'colorama',
    type: 'color',
    args: [
      { name: 'amount', default: 0.005, min: 0, max: 0.1, step: 0.001 },
    ],
  },
  ...
  // ── Blend / Combine ──────────────────────────────────────────────────────
  {
    ...
    type: 'combine',
    args: [
      { name: 'amount', default: 1, min: 0, max: 2, step: 0.01 },
    ],
  },
  {
    name: 'sub',
  ...
  },
  {
    ...
    type: 'combine',
    args: [
      { name: 'amount', default: 0.5, min: 0, max: 1, step: 0.01 },
    ],
  },
  {
    name: 'mult',
  ...
  // ── Modulate / CombineCoord ──────────────────────────────────────────────
  {
    ...
    type: 'combineCoord',
    args: [
      { name: 'amount', default: 0.1, min: -1, max: 1, step: 0.005 },
    ],
  },
  {
    name: 'modulateScale',
  ...
  },
  {
    ...
    type: 'combineCoord',
    args: [
      { name: 'amount', default: 1, min: 0, max: 5, step: 0.05 },
    ],
  },
  {
    name: 'modulateKaleid',
