...
import { getSourceFunctions, getTransformFunctions } from '../lib/functionRegistry';
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12, padding: '0 4px' }}>
          ...
          <button onClick={onClose} style={{ background: 'none', border: 'none', color: '#B0BEC5', cursor: 'pointer', fontSize: 18, padding: '0 4px' }}>
            ×
          </button>
        </div>
